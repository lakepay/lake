...
This mechanism has been integrated into Bitcore-Node-Lake which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lakepay/insight-api-dash#web-socket-api](https://github.com/lakepay/insight-api-dash#web-socket-api) 
* API: [https://github.com/lakepay/insight-api-dash#instantsend-transactions](https://github.com/lakepay/insight-api-dash#instantsend-transactions) 
...
By default, the Lake Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lake Core daemon:
