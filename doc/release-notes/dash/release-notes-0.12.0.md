...
Lake Core version 0.12.0 is now available from:

  https://lakepay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/lakepay/lake/issues
...
backwards-compatible with pre-0.12 versions of Lake Core or other software:
