...
Only requiring some minor changes is lake.cpp.
...
Changes to lake.cpp
----------------------
lake.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
