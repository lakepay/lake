...
* Update translations, see [translation_process.md](https://github.com/VyacheslavGrus/lake/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/VyacheslavGrus/lake-detached-sigs.git
	git clone https://github.com/devrandom/gitian-builder.git
	git clone https://github.com/VyacheslavGrus/lake.git
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [dash-detached-sigs](https://github.com/VyacheslavGrus/lake-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
