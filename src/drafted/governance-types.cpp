...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LakeNetwork") type = LakeNetwork;
    if(strType == "LakeNetworkVariable") type = LakeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LakeNetwork) s = "LakeNetwork";
    if(type == LakeNetworkVariable) s = "LakeNetworkVariable";
