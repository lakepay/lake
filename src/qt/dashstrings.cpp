...
QT_TRANSLATE_NOOP("dash-core", "Copyright (C) 2014-%i The Lake Core Developers"),
...
QT_TRANSLATE_NOOP("dash-core", "Error loading wallet.dat: Wallet requires newer version of Lake Core"),
...
QT_TRANSLATE_NOOP("dash-core", "Initialization sanity check failed. Lake Core is shutting down."),
...
QT_TRANSLATE_NOOP("dash-core", "Keep N LAKE anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("dash-core", "Wallet needed to be rewritten: restart Lake Core to complete"),
