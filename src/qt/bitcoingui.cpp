    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Lake Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lake address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lake: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Lake Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lake Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lake Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lake addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lake addresses"));
    ...
    openAction->setStatusTip(tr("Open a lake: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lake Core help message to get a list with possible Lake Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lake Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lake network", "", count));
}
...
{
    QString strTitle = tr("Lake Core"); // default title
