    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LAKE-light"), QVariant("light"));
    ui->theme->addItem(QString("LAKE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LAKE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LAKE-traditional"), QVariant("trad"));
