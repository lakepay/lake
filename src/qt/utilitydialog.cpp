    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Lake Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Lake Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  lake-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Lake in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LAKE, 0.1 LAKE, 1 LAKE and 10 LAKE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lakepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://lakepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Lake Core is shutting down...") + "<br /><br />" +
